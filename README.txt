...
'testdirectory/buell_hw03'. You should note that 'zdExecuteScript.txt'
specifically labels the output and log files and that this naming
is consistent with what you see in the sample input and output.
